...
DATABASES = {
    'default': {
        ...
        'HOST': 'blog-project-db.cvqmgligxtfu.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blogproject-bucket' # please enter your s3 bucket name
